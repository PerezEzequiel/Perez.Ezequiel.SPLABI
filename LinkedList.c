...
int ll_sortDouble(LinkedList* this, int (*pFunc)(void*,void*), int (*pFuncDos)(void*,void*), int order)
{
    int returnAux=-1;
    void* pElementAux=NULL;

    if(this!=NULL && pFunc!=NULL && pFuncDos &&(order == 1 || order == 0))
    {
        for(int i=0; i<ll_len(this)-1; i++)
        {
            for(int j=i+1; j<ll_len(this); j++)
            {
                ...
                if(order == 1)
                {
                    if((pFunc(ll_get(this,i),ll_get(this,j)) > 0) || (pFunc(ll_get(this,i),ll_get(this,j)) == 0 && pFuncDos(ll_get(this,i),ll_get(this,j)) > 0))
                    {
                        pElementAux = ll_get(this,i);
                        ll_set(this,i,ll_get(this,j));
                        ll_set(this,j,pElementAux);
 ...
 * \return LinkedList* Nuevo puntero a linkedList con los elementos que pasaron la funcion.
 *
 */
LinkedList* ll_filter(LinkedList* this,int (*pFunc)(void*))
{
    ...
    if(this!=NULL && pFunc != NULL)
    {
        ...
        if(nuevoLinkedList!=NULL)
        {
            ...
            {
                pElementAux = ll_get(this,i);
                if(pFunc(pElementAux))
                {
                    if(ll_add(nuevoLinkedList,pElementAux))
                    {
                        ll_deleteLinkedList(nuevoLinkedList);
                        nuevoLinkedList=NULL;
                        break;
                    }
                }
            }
...
/** \brief Devuelve un linkedList cargado con valores
 *
 * \param *pFunc Puntero a la funcion que setea valores
 * \return LinkedList* Nuevo puntero a linkedList con los elementos seteados.
 *
 */
LinkedList* ll_map (LinkedList* this, void*(*pFunc) (void* element))
{
    ...
    int size;
    void* pElementAux=NULL;
    void* pElementMap=NULL;

    if(this!=NULL && pFunc != NULL)
    {
        nuevoLinkedList = ll_clone(this);
        if(nuevoLinkedList!=NULL)
        {
            size = ll_len(this);
            for(int i=0; i<size; i++)
            {
                pElementAux=ll_get(this,i);
                pElementMap = pFunc(pElementAux);
                if(pElementMap!=NULL)
                {
                    if(ll_set(nuevoLinkedList,i,pElementMap))
                    {
                        ll_deleteLinkedList(nuevoLinkedList);
                        nuevoLinkedList=NULL;
                        break;
